# Copy of the full ais_agent.py from the repository so the bridge can run
# in development mode by mounting the host `agents/ais_agent` directory. This
# file intentionally mirrors the upstream agent implementation.
...
def make_identifier_params(ship_id: Optional[str], mmsi: Optional[str], imo: Optional[str]) -> Dict[str, Any]:
    ...
    params: Dict[str, Any] = {}
    if ship_id: params["shipid"] = ship_id
