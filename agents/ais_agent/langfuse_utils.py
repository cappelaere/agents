"""
Langfuse tracing utilities for the AIS REST gateway.
...
def trace_start(request):
    ...
    The span name is derived from the request path, and the input payload
    includes session id, query parameters, HTTP method, and path.
    """
